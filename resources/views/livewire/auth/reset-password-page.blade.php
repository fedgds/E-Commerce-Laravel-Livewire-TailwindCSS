              ...
              <form>
                <div class="grid gap-y-4">
                  ...
                  <div>
                    ...
                    <p class="hidden text-red-600 mt-2" id="password-error">Lỗi</p>
                  </div>
                  <!-- End Form Group -->
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input type="password" id="password_confirmation" name="password_confirmation" class="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-rose-500 focus:ring-rose-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="email-error">
                    ...
                    <p class="text-xs text-red-600 mt-2" id="password_confirmation-error">Lỗi</p>
                  </div>
