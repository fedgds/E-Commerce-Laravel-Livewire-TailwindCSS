        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full px-4 md:w-1/2 ">
            <div class="lg:pl-20">
              <div class="mb-8 ">
                ...
                <p class="inline-block mb-3 text-2xl font-bold text-gray-900 dark:text-gray-400 ">
                  ...
                  @if ($product->sale_price)
                    ...
                    <span class="text-sm border border-rose-300 bg-rose-700 text-white px-2 py-1 rounded-full">-{{ round(($product->price-$product->sale_price)*100/$product->price) }} %</span>
                  @else
              ...
              <div class="w-32 mb-8 ">
                <label for="" class="inline-block mb-3 text-2xl font-bold text-gray-900 dark:text-gray-400 border-b border-rose-500">Số lượng</label>
              ...
              <div class="flex flex-wrap items-center gap-4">
                <button wire:click='addToCart({{ $product->id }})' class="w-full p-3 bg-gray-900 rounded-full lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-rose-600 dark:bg-rose-500 dark:hover:bg-rose-500">
