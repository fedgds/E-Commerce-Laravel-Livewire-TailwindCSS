<div>
    {{-- Start Hero Section --}}
    <div class="w-full h-screen bg-rose-100 from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          <!-- Grid -->
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-700 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Bắt đầu hành trình với <span class="text-rose-500">Shopwise</span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Mua nhiều loại sản phẩm điện tử như Điện thoại thông minh, Máy tính xách tay, Đồng hồ thông minh, Tivi và nhiều sản phẩm khác.</p>
      
              <!-- Buttons -->
              <div class="mt-7 w-full sm:inline-flex">
                <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-rose-500 text-white hover:bg-rose-600 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/register">
                  Bắt đầu
            ...
            <div class="relative ms-4">
              <img class="w-full rounded-md" src="/img/banner.webp" alt="Image Description">
        ...
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 style="font-family: cursive" class="text-5xl dark:text-gray-200 mb-3"> Hợp tác với <span class="text-rose-600">Thương Hiệu</span></h1>
            </div>
    ...
    <div class="bg-rose-100 py-20">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 style="font-family: cursive" class="text-5xl text-rose-600 dark:text-gray-200 mb-3">Danh Mục</h1>
            </div>
            <p class="mb-12 text-base text-center text-gray-500">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus magni eius eaque?
              Pariatur
    ...
    <section class="py-14 font-poppins bg-rose-100">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
          <div class="max-w-xl mx-auto">
            <div class="text-center ">
              <div class="relative flex flex-col items-center">
                <h1 style="font-family: cursive" class="text-5xl dark:text-gray-200 mb-3"><span class="text-rose-500">Đánh giá</span> của khách hàng</h1>
              </div>
              <p class="mb-12 text-base text-center text-gray-500">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus magni eius eaque?
                Pariatur
