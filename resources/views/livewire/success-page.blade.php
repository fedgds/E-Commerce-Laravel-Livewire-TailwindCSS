            ...
            <div>
                ...
                <div class="flex items-start justify-start flex-shrink-0">
                    ...
                    <div class="flex flex-col items-start justify-start space-y-2">
                        ...
                        <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ $address->district }} - {{ $address->city }}</p>
                        <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ $address->address }}</p>
                        <p class="text-sm leading-4 cursor-pointer dark:text-gray-400">Số điện thoại: {{ $address->phone }}</p>
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="w-full px-4 mb-4 md:w-1/4">
                    ...
                    Tổng tiền: </p>
                    <p class="text-base font-semibold leading-4 text-rose-600 dark:text-gray-400">
